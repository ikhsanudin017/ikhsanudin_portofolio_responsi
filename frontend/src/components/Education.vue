...
onMounted(async () => {
  try {
    ...
    console.error("Gagal mengambil data pendidikan dari backend:", error);
    educationHistory.value = [
      { id: 1, period: '2023 - Sekarang', institution: 'Universitas Amikom Yogyakarta', major: 'S1 Informatika' },
      { id: 2, period: '2018 - 2021', institution: 'SMK IT Smart Informatika', major: 'Teknik Komputer & Jaringan' }
    ];
  }
  ...
  document.querySelectorAll('.card-timeline').forEach(card => {
