...
onMounted(async () => {
  try {
    ...
    projects.value = [
      { id: 99, title: "Error Fetching Data", description: "Tidak dapat terhubung ke server. Pastikan server backend sudah berjalan.", image: "https://images.unsplash.com/photo-1579373903781-fd5c0c30c4cd?w=500&h=300&fit=crop", tech: ["Error"], repoUrl: "#", liveUrl: "#" }
    ];
  }
